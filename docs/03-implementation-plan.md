...
| N09 | T02/T13/T14 및 pre-commit/PR secret scan |
| N10/N11 | T10/T14 |
...
커밋 전 pre-commit과 GitHub push/PR에서 Gitleaks, 개인키 및 민감 파일명 검사를 통과해야 한다. 의존성 보안 업데이트는 Dependabot으로 추적하며 검사 우회는 정상 배포 절차로 인정하지 않는다.
