...
export default function App() {
  ...
  return <main>
    ...
    <SettingsPage role={user.role} robots={state?.robots ?? []} selectedRobot={selectedRobot} onError={setError} onLoaded={value => setCameraQuality(value.camera_quality)} onSaved={value => { setGoal(null); setCameraQuality(value.camera_quality); setState(current => current ? { ...current, map_id: value.active_map_id } : current) }} />
